...
app.get('/api/books', (req, res) => {
    fs.readFile('data.json', (err, data) => {
        if (err) {
            console.log(`Error while reading file in post ${error}`)
            res.send(`Error while reading file in post ${error}`);
        } else {
            books = JSON.parse(data);
            res.send(books);
        }
...
app.get('/api/books/:id', (req, res) => {
    ...
    fs.readFile('data.json', (err, data) => {
        if (err)
            ...
            if (getFlag == true) {
                res.send('Bad request book not found');
            }
...
app.put('/api/books/:id', validatetherequest, function(req, res) {
